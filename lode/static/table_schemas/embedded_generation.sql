CREATE TABLE IF NOT EXISTS embedded_generation_%s
(
embedded_generation_key serial primary key,
POC varchar(7),
NWK_Code varchar(4),
...
UNIQUE(POC,NWK_Code,Participant_Code,Flow_Direction,Trading_date)
);
